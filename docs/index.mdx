...
<CardGroup cols={2}>
  ...
  <Card title="Multi-harness support" icon="grid-2">
    14 built-in harness profiles for Claude Code, GitHub Copilot CLI, OpenHands, Cursor, Aider, Cline, Goose, Continue.dev, Windsurf, Codex CLI, Amazon Q Developer, Gemini CLI, Roo-Code, and Bolt.new — each with its own color and detection heuristics.
  </Card>
